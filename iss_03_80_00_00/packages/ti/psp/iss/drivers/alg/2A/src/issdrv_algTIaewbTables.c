...
ALG_AewWeightParam WeightMatrixPrm;
ALG_AewWeightParam WeightSpotPrm;
ALG_AewWeightParam WeightCenterPrm;
/* ===================================================================
 ...
 *  ==================================================================
 */      
void generate_windows(ALG_AewWeightParam Prm,unsigned char *win_coeffs)
{
	...
	int width1 = Prm.width1;
	int height1 = Prm.height1;
	int h_start2 = Prm.h_start2;
	int v_start2 = Prm.v_start2;
	int width2 = Prm.width2;
	int height2 = Prm.height2;
	int weight = Prm.weight;
...
#endif
	WeightMatrixPrm.width1 = width;
	WeightMatrixPrm.height1 = height;
	WeightMatrixPrm.h_start2 = 0;
	WeightMatrixPrm.v_start2 = 0;
	WeightMatrixPrm.width2 = width;
	WeightMatrixPrm.height2 = height/2;
	WeightMatrixPrm.weight = 50;
	
	WeightCenterPrm.width1 = width;
	WeightCenterPrm.height1 = height;
	WeightCenterPrm.h_start2 = width/4;
	WeightCenterPrm.v_start2 = height/4;
	WeightCenterPrm.width2 = width/2;
	WeightCenterPrm.height2 = height/2;
	WeightCenterPrm.weight = 50;
	
	WeightSpotPrm.width1 = width;
	WeightSpotPrm.height1 = height;
	WeightSpotPrm.h_start2 = width*3/8;
	WeightSpotPrm.v_start2 = height/3;
	WeightSpotPrm.width2 = width/4;
	WeightSpotPrm.height2 = height/4;
	WeightSpotPrm.weight = 80;

    generate_windows(WeightMatrixPrm, TI_WEIGHTING_MATRIX); 
    generate_windows(WeightCenterPrm, TI_WEIGHTING_CENTER);
    generate_windows(WeightSpotPrm, TI_WEIGHTING_SPOT);
