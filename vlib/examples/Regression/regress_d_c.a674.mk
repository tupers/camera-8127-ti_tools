...
#*******************************************************************************
#* FILE NAME: Regression/regress_d_c.a674.mk
#*
...
$(COMMONTESTSRCCOBJS):Regression\regress_d_c.a674.mk
Regression\regress_d_c.a674.mk:
...
Regression/regress_d_c.a674 : $(COMMONTESTSRCCOBJS)
	@echo archiving $? into $@ ...
	@echo "rq $@ $?">$@.cmd
	$(ARIN) @$@.cmd
