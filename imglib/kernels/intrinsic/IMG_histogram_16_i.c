...
#pragma CODE_SECTION(IMG_histogram_16_c,   ".text:intrinsic");
...
)
{
    ...
    /* -------------------------------------------------------------------- */
    {
        ...
        const double *restrict even_img = (const double*)&in[0];
        const double *restrict odd_img  = (const double *)&in[4];
...
/* ======================================================================== */
/*  End of file:  IMG_histogram_16_i.c                                      */
/* ------------------------------------------------------------------------ */
/*            Copyright (c) 2008 Texas Instruments, Incorporated.           */
/*                           All Rights Reserved.                           */
/* ======================================================================== */
