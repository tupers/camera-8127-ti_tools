...
/**DDR config register configure */
#define SDRAM_TYPE(n)	(n<<29)
#define IBANK_POS(n)	(n<<27)
#define DDR_TERM(n)		(n<<24)
#define DDR_DQS(n)		(n<<23)
#define DYN_ODT(n)		(n<<21)
#define DDR_DLL(n)		(n<<20)
#define SDRAM_DRIVE(n)	(n<<18)
#define CWL(n)			(n<<16)
#define NARROW_BITS(n)	(n<<14)
#define CL(n)			(n<<10)
#define ROW_SIZE(n)		(n<<7)
#define IBANK(n)		(n<<4)
#define EBANK(n)		(n<<3)
#define PAGESIZE(n)		(n<<0)

/** DDR Timer1 register configure */
#define T_RP(n)			(n<<25)
#define T_RCD(n)		(n<<21)
#define T_WR(n)			(n<<17)
#define T_RAS(n)		(n<<12)
...
/** DDR Timer2 register configure */
#define T_XP(n)         (n<<25)
#define T_XSNR(n)       (n<<16)
#define T_XSRD(n)       (n<<6)
#define T_RTP(n)        (n<<3)
#define T_CKE(n)        (n<<0)
...
/*
#define DDR3_PHY_RD_DQS_CS0_BYTE0		((emif == 0) ? 0x3d : 0x39) 
#define DDR3_PHY_RD_DQS_CS0_BYTE1		((emif == 0) ? 0x3c : 0x3c)
#define DDR3_PHY_RD_DQS_CS0_BYTE2		((emif == 0) ? 0x3e : 0x3c) 
#define DDR3_PHY_RD_DQS_CS0_BYTE3		((emif == 0) ? 0x3d : 0x3e) 

#define DDR3_PHY_WR_DQS_CS0_BYTE0		((emif == 0) ? 0x45 : 0x40) 
#define DDR3_PHY_WR_DQS_CS0_BYTE1		((emif == 0) ? 0x44 : 0x3f) 
#define DDR3_PHY_WR_DQS_CS0_BYTE2		((emif == 0) ? 0x47 : 0x45)
#define DDR3_PHY_WR_DQS_CS0_BYTE3		((emif == 0) ? 0x47 : 0x42) 

#define DDR3_PHY_RD_DQS_GATE_CS0_BYTE0		((emif == 0) ? 0x9d : 0x9e) 
#define DDR3_PHY_RD_DQS_GATE_CS0_BYTE1		((emif == 0) ? 0x9e : 0x9c) 
#define DDR3_PHY_RD_DQS_GATE_CS0_BYTE2		((emif == 0) ? 0xa7 : 0xa3)
#define DDR3_PHY_RD_DQS_GATE_CS0_BYTE3		((emif == 0) ? 0xa9 : 0xa9) 

#define DDR3_PHY_WR_DATA_CS0_BYTE0		((emif == 0) ? 0x7e : 0x78) 
#define DDR3_PHY_WR_DATA_CS0_BYTE1		((emif == 0) ? 0x7f : 0x7b) 
#define DDR3_PHY_WR_DATA_CS0_BYTE2		((emif == 0) ? 0x7f : 0x7b) 
#define DDR3_PHY_WR_DATA_CS0_BYTE3		((emif == 0) ? 0x80 : 0x7e) 
*/


/* TI814X DDR3 PHY CFG parameters   <emif0 : emif 1> */
#define DDR3_PHY_RD_DQS_CS0_BYTE0		((emif == 0) ? 0x35 : 0x35)
#define DDR3_PHY_RD_DQS_CS0_BYTE1		((emif == 0) ? 0x37 : 0x37)
#define DDR3_PHY_RD_DQS_CS0_BYTE2     	((emif == 0) ? 0x36 : 0x36)
#define DDR3_PHY_RD_DQS_CS0_BYTE3     	((emif == 0) ? 0x34 : 0x34)

#define DDR3_PHY_WR_DQS_CS0_BYTE0     	((emif == 0) ? 0x41 : 0x41)
#define DDR3_PHY_WR_DQS_CS0_BYTE1     	((emif == 0) ? 0x44 : 0x44)
#define DDR3_PHY_WR_DQS_CS0_BYTE2     	((emif == 0) ? 0x3B : 0x3B)
#define DDR3_PHY_WR_DQS_CS0_BYTE3     	((emif == 0) ? 0x3C : 0x3C)

#define DDR3_PHY_RD_DQS_GATE_CS0_BYTE0    ((emif == 0) ? 0xA1 : 0xA1)
#define DDR3_PHY_RD_DQS_GATE_CS0_BYTE1    ((emif == 0) ? 0xA4 : 0xA4)  
#define DDR3_PHY_RD_DQS_GATE_CS0_BYTE2    ((emif == 0) ? 0x35 : 0xA8)  
#define DDR3_PHY_RD_DQS_GATE_CS0_BYTE3    ((emif == 0) ? 0xA6 : 0xA6) 

#define DDR3_PHY_WR_DATA_CS0_BYTE0        ((emif == 0) ? 0x77 : 0x77)
#define DDR3_PHY_WR_DATA_CS0_BYTE1        ((emif == 0) ? 0x77 : 0x77)
#define DDR3_PHY_WR_DATA_CS0_BYTE2        ((emif == 0) ? 0x77 : 0x77)
#define DDR3_PHY_WR_DATA_CS0_BYTE3        ((emif == 0) ? 0x77 : 0x77)
...
#define    DDR3_EMIF_READ_LATENCY	0x00170208
#define    DDR3_EMIF_TIM1			0x0AAAE4DB
#define    DDR3_EMIF_TIM2			0x208F7FDA
#define    DDR3_EMIF_TIM3			0x007F88BF
#define    DDR3_EMIF_REF_CTRL		0x00000618
#define		DDR3_EMIF_SDRAM_CONFIG	0x61C21332
#define		DDR3_EMIF_SDRAM_CONFIG2 0x0		
#define    DDR3_EMIF_SDRAM_ZQCR		0x50074BE1


//#define    DDR3_EMIF_READ_LATENCY	0x0017030C
//#define    DDR3_EMIF_TIM1			0x1557B9A5
//#define    DDR3_EMIF_TIM2			0x4C5F7FEB
//#define    DDR3_EMIF_TIM3			0x00000578
//#define    DDR3_EMIF_REF_CTRL		0x10000C30
 ...
 * 1G contiguous section with 512-byte interleaving
 */
...
//#define PG2_1_DMM_LISA_MAP__3		0x80640320

#define PG2_1_DMM_LISA_MAP__0		0x80540300
#define PG2_1_DMM_LISA_MAP__1		0xA0540310
#define PG2_1_DMM_LISA_MAP__2		0xC0540320
#define PG2_1_DMM_LISA_MAP__3		0xE0540330
/*
