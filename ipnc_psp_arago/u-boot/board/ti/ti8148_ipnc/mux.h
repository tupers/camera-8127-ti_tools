...
/* 107-GP1[13] 108- GP1[14] */
/* -108 */	BIT(0), BIT(0), BIT(7), BIT(7),
/* 110-SPI2_D0 111-HDMI_CEC 112-HDMI_HPDET */
/* -112 */	BIT(0), BIT(2), BIT(2), BIT(2),
/* 115 TIM6_IO 116 TIM7_IO */
/* -116 */	BIT(0), BIT(0), BIT(6), BIT(6),
/* -120 */	BIT(0), BIT(0), BIT(0), BIT(0),
/* -124 */	BIT(0), BIT(0), BIT(0), BIT(0),
/* -128 */	BIT(2), BIT(0), BIT(0), BIT(0),
